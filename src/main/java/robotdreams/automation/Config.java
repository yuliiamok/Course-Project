...
public class Config {
    ...
    static final public Param HTTP_BASE_PROTOCOL = new Param("http.base.protocol",    "http",      true);
    static final public Param HTTP_BASE_URL      = new Param("http.base.url",         "localhost", true);
    static final public Param HTTP_BASE_PORT     = new Param("http.base.port",        "443",       true);
    ...
    static final public Param API_BASE_PROTOCOL = new Param("api.base.protocol",   "http",      true);
    ...
    static final public Param API_USER_NAME     = new Param("api.user.name",       null,        true);
    static final public Param API_USER_PASSWORD = new Param("api.user.password",   null,        true);
